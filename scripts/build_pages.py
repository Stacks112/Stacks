    ...
    Array.prototype.forEach.call(hosts, function(host){
      ...
      try {
        ...
        /* Bind before createTweet: X can emit rendered before its promise
           ...
           The promise resolution below is a safe fallback for X builds that
           emit too early. */
        ...
        Promise.resolve(twttr.widgets.createTweet(id, slot, {
          ...
          reveal();
          /* iframe load can be an X error document. The rendered event above
             or the successful promise may hide the static fallback; failed
             embeds keep their source. */
