...
ARTICLE_HUB_FILE = {"ko": "articles.html", "en": "articles-en.html", "ja": "articles.html"}
...
def latest_block(cur_id, lang, U, skip=(), limit=8):
    ...
    return ('<nav class="latest"><h3>%s</h3><ul>%s</ul>'
            ...
            % (E(U["latest"]), rows, LANG_REL[lang], ARTICLE_HUB_FILE[lang], E(U["allmore"])))
...
{('<meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1">\\n' if lang == "en" else '')}<link rel="canonical" href="{E(url)}">
...
def articles_index(items, lang="ko"):
    if lang == "en":
        rows = "".join(
            f'<li><a href="p/en/{E(i["id"])}.html">{E(i["title"].get("en") or i["title"].get("ko") or i["id"])}</a>'
            f' <span class="d">{E(dispname(i.get("source", "")))} - {E(i.get("date", ""))}</span></li>'
            for i in items if (i.get("title") or {}).get("en")
        )
        return f"""<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>All articles · {SITE}</title>
<meta name="description" content="All English investing articles from Stacks, with original sources and dates.">
<meta name="robots" content="index,follow,max-image-preview:large">
<link rel="canonical" href="{BASE}articles-en.html">
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1656582515648973" crossorigin="anonymous"></script>
<link rel="alternate" type="application/rss+xml" title="Stacks" href="feed-en.xml">
<style>
body{{font-family:-apple-system,"Segoe UI",Roboto,sans-serif;max-width:720px;margin:0 auto;padding:24px 20px 60px;line-height:1.6;color:#17181C;background:#fff}}
@media(prefers-color-scheme:dark){{body{{background:#0E0F12;color:#ECEDF1}}}}
a{{color:inherit}} h1{{font-size:22px}} ul{{list-style:none;padding:0}}
li{{padding:12px 0;border-bottom:1px solid #ECEDF1}}
.d{{display:block;font-size:12px;color:#8E93A0;margin-top:3px}}
</style>
{app_link_js("en")}
...
<body>
<main>
<h1><a href="./" style="text-decoration:none">Stacks</a> · All articles</h1>
<p style="color:#8E93A0">English investing reads, summaries, and source links.</p>
<ul>{rows}</ul>
</main>
</body>
</html>
...
def sitemap(items, entity_slugs=None, week_slugs=None, theme_slugs=None, record_slugs=None):
    ...
    urls = [(BASE, now, "1.0", None),
            ...
            (BASE + "articles-en.html", now, "0.6", None),
...
def main():
    ...
    if og:
        ...
        for i in items:
            if os.path.exists(f"og/{i['id']}.png"):
                og_ok.add(i["id"])
    ...
    open("articles-en.html", "w", encoding="utf-8").write(articles_index(items, "en"))
